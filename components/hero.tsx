...
export default function MagazineCover() {
  ...
  return (
    <div className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 text-white text-center px-4 max-w-4xl h-full flex flex-col justify-between py-12">
        <div>
          <motion.h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold mb-2 sm:mb-3 leading-tight animate-fade-in-up">
            {content.title}
